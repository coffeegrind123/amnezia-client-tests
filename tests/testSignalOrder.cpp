...
private slots:
    ...
    void testSignalOrderOnRemoveDefault() {
        ...
        QVERIFY2(m_coreController->serversRepository()->defaultServerIndex() == 1, "Default should be index 1");
        ...
        QVERIFY2(defaultServerChangedSpy.at(0).at(0).toString() == m_coreController->serversRepository()->defaultServerId(),
